...
namespace Game.Online.Manager.Auth
{
    public class LoginPage : MonoBehaviour
    {
        ...
        [SerializeField] private ConnectionProvider _connProvider;
        [SerializeField] private AuthProvider _authProvider;
    ...
    public void RegisterEnter()
    {
        ...
        if (confirm == registerpass && Regex.IsMatch(email, format, RegexOptions.IgnoreCase) && registerpass.Length >= 8)
        {
            ...
            _authProvider.RegisterRequest(RegisterID, registerpass, email);
        }
